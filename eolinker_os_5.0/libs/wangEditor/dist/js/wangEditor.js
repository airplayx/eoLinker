...
_e(function (E, $) {
    ...
    E.fn.create = function () {
        ...
        // 执行 addMenus 之前：
        // 1. 允许用户编辑 editor.UI 自定义配置UI
        // 2. 允许用户通过编辑 editor.menus 来自定义配置菜单
    ...
    Menu.fn._renderTip = function ($menuItem) {
        ...
        if (!self.tipWidth) {
            ...
            editor.ready(function () {
                var editor = this;
                var titleWidth = $tempDiv.width() + 5; // 多出 5px 的冗余
                var currentWidth = $tip.width();
...
_e(function (E, $) {
    ...
    DropList.fn._position = function () {
        ...
        // 取得 $txt 的尺寸
        var txtWidth = editor.txt.$txt.width();
        ...
        if (editor._isMenufixed) {
            top = top + (($menuContainer.offset().top + $menuContainer.height()) - $list.offset().top);
...
_e(function (E, $) {
    ...
    DropPanel.fn._position = function () {
        ...
        // 如果因为向下滚动而导致菜单fixed，则再加一步处理
        if (editor._isMenufixed) {
            top = top + (($menuContainer.offset().top + $menuContainer.height()) - $panel.offset().top);
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $textInput = $('<input autocomplete="off" type="text" class="block" placeholder="' + lang.text + '"/>');
        var $urlInput = $('<input autocomplete="off" type="text" class="block" placeholder="' + lang.link + '"/>');
    ...
    E.createMenu(function (check) {
        ...
        function insertEmotionImgs(data, $tabContent) {
            ...
            $.each(data, function (k, emotion) {
                ...
                // 通过配置 editor.config.emotionsShow 的值来编辑插入到编辑器的内容（图片/value）
        ...
        $.each(configEmotions, function (k, emotion) {
            ...
            if (typeof data === 'string') {
                ...
                // 其他情况，data格式不对
                E.error('data 数据格式错误，请编辑为正确格式，参考文档：' + E.docsite);
                return;
            }
        });
...
_e(function (E, $) {
    ...
    function linkContentHandler (editor, menu, $linkContent) {
        ...
        var $urlInput = $('<input autocomplete="off" type="text" class="block" placeholder="http://"/>');
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $linkInput = $('<input autocomplete="off" type="text" class="block" placeholder=\'格式如：<iframe src="..." frameborder=0 allowfullscreen></iframe>\'/>');
        $linkInputContainer.append($linkInput);
        var $sizeContainer = $('<div style="margin:20px 10px;"></div>');
        var $widthInput = $('<input autocomplete="off" type="text" value="640" style="width:50px;text-align:center;"/>');
        var $heightInput = $('<input autocomplete="off" type="text" value="498" style="width:50px;text-align:center;"/>');
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $cityInput = $('<input autocomplete="off" type="text"/>');
        $cityInput.css({
            width: '80px',
            'text-align': 'center'
        });
        var $searchInput = $('<input autocomplete="off" type="text"/>');
        $searchInput.css({
            width: '300px',
            'margin-left': '10px'
        ...
        var $check = $('<input autocomplete="off" type="checkbox">');
...
_e(function (E, $) {
    ...
    UploadFile.fn.render = function () {
        ...
        var $input = $('<input autocomplete="off" type="file" ' + acceptTpl + ' ' + multipleTpl + '/>');
...
_e(function (E, $) {
    ...
    UploadFile.fn.render = function () {
        ...
        var multipleTpl = multiple ? 'multiple="multiple"' : '';
        var $p = $('<p>选择图片并上传</p>');
        var $input = $('<input autocomplete="off" type="file" ' + multipleTpl + ' name="' + uploadFileName + '"/>');
        var $btn = $('<input autocomplete="off" type="submit" value="上传"/>');
        var $form = $('<form  autocomplete="off" enctype="multipart/form-data" method="post" action="' + uploadUrl + '" target="' + iframeId + '"></form>');
        ...
        $.each(editor.config.uploadParams, function (key, value) {
            $form.append( $('<input autocomplete="off" type="hidden" name="' + key + '" value="' + value + '"/>') );
        });
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        function show() {
            ...
            var tableHeight = $currentTable.height();
            ...
            var txtHeight = $currentTxt.height();
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $linkInput = $('<input autocomplete="off" type="text" style="height:26px; margin-left:10px; width:200px;"/>');
...
_e(function (E, $) {
    E.plugin(function () {
        ...
        function setPosition() {
            ...
            var menuHeight = editor.menuContainer.height();
            var txtHeight = editor.txt.$txt.height();
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        // UI
        var $uploadIcon = $('<input autocomplete="off" class=" hidden" type="file"><div class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></div>');
        $uploadContent.append($uploadIcon);
